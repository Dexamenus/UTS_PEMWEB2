        ...
        <div className="min-h-screen">
            ...
            <section id="jadwal">
                <div className="bg-pink-50">
                    ...
                    <div className="py-20 p-50 grid grid-cols-1 md:grid-cols-2 gap-6 ">
                        <Collaps
