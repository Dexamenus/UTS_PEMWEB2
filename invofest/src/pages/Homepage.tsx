      ...
      <div className='max-w-7xl mx-auto  px-6 py-2'>
        ...
        >
          <div className='w-2/3 flex flex-col gap-6'>
            <img
              ...
              className='w-96'
            />
            <p className='text-sm md:text base lg:text-[1.35rem] text-slate-600'>
        ...
        <section
          ...
          <div className='w-full'>
            <div>
              <h1 className='text-5xl mb-6 font-semibold text-red-900'>Tentang INVOFEST</h1>
              <p className='text-sm md:text base lg:text-[1.35rem] text-slate-600'>
        ...
        <section
          ...
          <div className='w-full mx-auto mt-4'>
            <div className='flex flex-col justify-center items-center'>
              ...
              <p className='text-base text-slate-600 mt-5'>Ada banyak informasi yang terkait dengan INVOFEST, Anda dapat melihat daftar pertanyaan di bawah ini.</p>
            </div>
