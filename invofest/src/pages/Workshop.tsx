            ...
            <section id="hero" className="py-20">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-10 items-center w-full">
                    <div className="w-full flex flex-col gap-6 md:w-2/1">
                        ...
                        <h3 className="text-3xl text-red-900 font-semibold">
            ...
            <section id="deskripsi">
                <div className="max-w-7xl mx-auto py-20">
                    <div className="flex flex-col justify-center items-center gap-6 max-w-5xl mx-auto px-6">
                        <h1 className="font-semibold text-5xl text-center text-red-900">
                            Tentang IT Workshop
                        </h1>
                        <p className="text-center md:text-lg text-slate-600 text-4xl">
            ...
            <section id="collaps">
                <div className="py-24">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h1 className="text-4xl font text-gray-800">Punya Pertanyaan? Lihat</h1>
