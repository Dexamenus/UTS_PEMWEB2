...
import { Collaps } from "../components/collapse.tsx";
    ...
    return (
        <div className="min-h-screen">
            ...
            <section id="hero" className="py-20">
                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-10  items-center w-full">
                    ...
                    <div className="w-full flex flex-col gap-6 md:w-2/1">
                        ...
                        <h3 className='text-3xl text-red-900 font-semibold'>“Human-AI Integration: Merancang Arsitektur Kolaboratif, Bukan Kompetitif”</h3>
                        <p className="text-xl text-slate-600">Seminar nasional yang membahas strategi dan arsitektur teknologi untuk menciptakan sistem di mana manusia dan AI bekerja sebagai mitra yang sinergis.Yang bertujuan mengubah paradigma dari persaingan menjadi kolaborasi, serta meningkatkan pengetahuan peserta dalam merancang teknologi AI yang berpusat pada manusia.</p>
                        <div className="mt-4">
                            <Button 
            ...
            <section id="card">
                <div className="max-w-7xl mx-auto py-20">
                    <div className="py-6">
                        <h1 className="font-semibold text-3xl text-center text-red-900">Temui Pembicara Khusus Kami</h1>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-30 p-3 w-full">
            ...
            <section id="jadwal">
                <div className=" bg-pink-50">
                    ...
                    <div className="py-10 p-50 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Collaps
